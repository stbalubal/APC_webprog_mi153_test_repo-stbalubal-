...
<link rel="stylesheet" type="text/css" href="css/style.css"/>
	...
	body {
		background-image: src=("<?php echo Yii::$app->request->baseUrl . "/Images/bg.jpg";?>");
...
<table border="0" cellpadding="5" >
	...
	<tr>
		<td>
		<img border="0" src=<?php echo Yii::$app->request->baseUrl . "/Images/me.jpg";?> style="float:left" height=300>
		</td>
